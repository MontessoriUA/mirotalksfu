...
window.MontemeetDict = {
    MSG: {
        ...
        // сток склеивает заголовок из двух половин, поэтому кладём готовые строки целиком
        'Eject current participant?': { uk: 'Відключити цього учасника?', ru: 'Отключить этого участника?' },
        'Eject All participants except yourself?': { uk: 'Відключити всіх, крім вас?', ru: 'Отключить всех, кроме вас?' },
        'Eject reason': { uk: 'Причина відключення', ru: 'Причина отключения' },
        'Я педагог — войти': { uk: 'Я педагог — увійти', en: 'I am the teacher — sign in' },
        // в заголовок окна ожидания сток подставляет само название действия
